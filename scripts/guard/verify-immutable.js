 ...
 * - To refresh baseline, set env MMC_LOCK_CODE and run: node scripts/guard/verify-immutable.js update
...
if (mode === 'verify') verify();
  ...
  console.error('Usage: node scripts/guard/verify-immutable.js [verify|update]');
  process.exit(4);
}
