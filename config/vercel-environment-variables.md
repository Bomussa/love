...
## تنبيه تشغيلي للإنتاج (Production)

> ⚠️ **شرط إلزامي للنشر:** لا تقم بنشر الواجهة الأمامية إذا كانت `VITE_SUPABASE_URL` أو `VITE_SUPABASE_ANON_KEY` غير معرفة في Vercel.
>
> ابتداءً من الإصدار الحالي، التطبيق يفشل عمدًا في الإقلاع ويعرض شاشة خطأ واضحة عند غياب أي من هذين المتغيرين، ولن يحاول استخدام أي مفتاح placeholder.
>
> النتيجة المباشرة: **تعطّل الواجهة بالكامل** حتى يتم ضبط المتغيرين وإعادة النشر.
