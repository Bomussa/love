...
const ALL_FUNCTIONS = [
  ...
  'enter_clinic', 'enter_queue_v2', 'enter_queue', 'enter_queue_safe',
...
const TABLE_CATEGORIES = {
  'core': ['clinics', 'patients', 'queues', 'pins', 'settings', 'routes', 'route_steps'],
...
const FUNCTION_CATEGORIES = {
  'queue': ['call_next_patient', 'enqueue_patient', 'enter_queue', 'get_queue_position', 'postpone_patient_secure'],
...
const APIMonitor = ({ language = 'ar', t }) => {
  ...
  const runFullCheck = useCallback(async () => {
    ...
    try {
      ...
      const coreFunctions = [
        'generate_daily_pins', 'get_current_pins', 'enter_queue_safe',
