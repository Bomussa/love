...
// التحقق من إعدادات Supabase قبل أي محاولة إنشاء عميل


const validateSupabaseConfig = () => {
  if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
    throw new Error(
      'Missing Supabase configuration: define VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY before initializing persistent connections.',
    );
  }
};
