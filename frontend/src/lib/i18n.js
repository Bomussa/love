...
export const translations = {
  ar: {
    ...
    // ✅ إضافة المفاتيح الناقصة (من EN إلى AR)
    // Notifications Extended
    yourTurnNow: 'دورك الآن!',
    goImmediately: 'اذهب فوراً إلى',
    dontBeLate: 'لا تتأخر!',
    youAreNext: 'أنت التالي!',
    getReady: 'استعد',
    onlyOnePerson: 'شخص واحد فقط أمامك!',
    estimatedWait: 'وقت الانتظار المتوقع',
    yourTurnIsNear: 'دورك اقترب',
    peopleAhead: 'أشخاص أمامك',
    notice: 'تنبيه',
    information: 'معلومات',
    youMayWaitNear: 'يمكنك الانتظار بالقرب من',
    welcomeToMedicalCommittee: 'مرحباً بك في اللجنة الطبية',
    howToUse: 'كيفية الاستخدام',
    followNotifications: 'اتبع الإشعارات إلى كل عيادة',
    watchYourNumber: 'راقب رقمك في الشاشة',
    alertWhenNear: 'سيتم تنبيهك عند اقتراب دورك',
    goWhenYourTurn: 'اذهب إلى العيادة عندما يحين دورك',
    queueSystemExplained: 'نظام الطابور موضح',
    yourQueueInfo: 'معلومات طابورك',
    yourPosition: 'موقعك',
    beingServedNow: 'يتم خدمته الآن',
    allExamsCompleted: 'تم إنجاز جميع الفحوصات!',
    congratulations: 'مبروك!',
    nextStep: 'الخطوة التالية',
    goToReception: 'اذهب إلى استقبال اللجنة الطبية',
    toReceive: 'لاستلام',
    direction: 'الاتجاه',
    groundFloorMainEntrance: 'الطابق الأرضي - المدخل الرئيسي',
    firstClinicLocation: 'موقع أول عيادة',
    moveToNewFloor: 'انتقل إلى طابق جديد',
    nextClinic: 'العيادة التالية',
    clinic: 'العيادة',
    room: 'الغرفة',
    goToElevator: 'اذهب إلى المصعد',
    pressButton: 'اضغط الزر',
    estimatedTime: 'الوقت المتوقع',
    back: 'رجوع',

    // System Status
    waitForYourTurn: 'انتظر دورك',
    entryNotAvailable: 'الدخول غير متاح بعد',
    yourNumberIs: 'رقمك هو',
    currentlyServing: 'يتم خدمته حالياً',
    personsAhead: 'أشخاص أمامك',
    autoRepairSystem: 'نظام الإصلاح التلقائي',
    tableNeedsReview: 'جدول يحتاج مراجعة',
    autoRepairFailed: 'فشل الإصلاح التلقائي',
    autoRepairSuccess: 'نجح الإصلاح التلقائي',
    ...
    cancelled: 'تم إلغاؤه',
    noShow: 'لم يحضر',
    transferredTo: 'تم نقله إلى',
    completedAt: 'اكتمل في',
    enteredAt: 'دخل في',
    calledAt: 'تم استدعاؤه في',
    ...
    someIssuesDetected: 'تم اكتشاف بعض المشاكل',
    ...
    every30Seconds: 'كل 30 ثانية',
    every1Minute: 'كل دقيقة',
